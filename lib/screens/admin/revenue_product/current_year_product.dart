...
class CurrentYearProduct extends StatefulWidget {
  const CurrentYearProduct({super.key});

  @override
  State<CurrentYearProduct> createState() => _CurrentYearProductState();
}

class _CurrentYearProductState extends State<CurrentYearProduct> {
  ...
  void fetchData() async {
    ...
    try {
      final data = await AdminService.fetchProductRevenueCurrentYear();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarProfile(
        name: "Thống kê doanh thu năm ${DateTime.now().year}",
      ),
      body: Container(
